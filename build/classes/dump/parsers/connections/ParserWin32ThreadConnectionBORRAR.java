 ...
 * @author Gonzalo
 */
public abstract class ParserWin32ThreadConnectionBORRAR extends ParserWin32 implements IParserConnection {
    ...
    public ParserWin32ThreadConnectionBORRAR(DumpFormat _dumpFormat, OperatingSystemStructure _os) {
        super(_dumpFormat, _os);
    }

    public ParserWin32ThreadConnectionBORRAR(DumpFormat _dumpFormat, OperatingSystemStructure _os, Translator _translator) {
