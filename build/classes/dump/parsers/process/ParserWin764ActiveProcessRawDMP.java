 ...
 * @author Gonzalo
 */
public class ParserWin764ActiveProcessRawDMP extends ParserWin64Process{

    public ParserWin764ActiveProcessRawDMP(RawDumpWin7 _dumpFormat, Windows764OS _os) {
    ...
    public ParserWin764ActiveProcessRawDMP(RawDumpWin7 _dumpFormat, Windows764OS _os, TranslatorWin64 _translator) {
    ...
    public void parse(Object[] params) {
        ...
        try {
            ...
            /**
             *
             * Obtiene dirección virtual de PsActiveProcessHead la estructura KDBG.
             * Es el puntero al primer elemento de la lista
             * doblemente enlazada de procesos activos en memoria
             */
            String psActiveProcessHeadString = (String) rawDump.getEntityKDBG().getAttributes().get("PsActiveProcessHead").getContent(); 
