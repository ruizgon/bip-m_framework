 ...
 * @author Gonzalo
 */
public class CrashDump32 extends CrashDump {
    
    private HeaderCrashDump32 _header;
    
    public CrashDump32(String _path, boolean littleEndian) {
        super(_path);
        this._randomFileSeeker = new RandomFileSeeker();
        this._header = new HeaderCrashDump32(_path, this._randomFileSeeker, littleEndian);
    ...
    public HeaderCrashDump32 getHeader() {
        return _header;
    }
    
    public void setHeader(HeaderCrashDump32 _header) {
    ...
    public long getFileOffset(BigInteger position) {
        ...
        PhysicalMemoryDescriptor32 physicalMemoryDescriptor32 = (PhysicalMemoryDescriptor32) this._header.getItems().get("PHYSICAL_MEMORY_BLOCK_BUFFER").getContent();
        
        Map<Integer, Run32> runs = physicalMemoryDescriptor32.getRuns();
        
        int numberOfRuns = physicalMemoryDescriptor32.getNumberOfRuns();
        ...
        offset = position.subtract(run.getStartAddress()).longValue();
        offset = offset + run.getFileOffset();
