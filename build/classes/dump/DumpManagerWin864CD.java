 ...
 * @author Gonzalo
 */
public class DumpManagerWin864CD extends DumpManager {

    public DumpManagerWin864CD(String _path, boolean _littleEndian) {
        super(_path, null, _littleEndian);
    }

    public static DumpManagerWin864CD getInstance(String path, boolean littleEndian) {
        if (_instance == null) {
            _instance = new DumpManagerWin864CD(path, littleEndian);
        }
        return (DumpManagerWin864CD) _instance;
    }
