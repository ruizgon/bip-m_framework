 ...
 * @author juani
 */
public class MapperMySQLWin764 extends MapperGeneric {

    private MapperDumpFormat _mapperDumpFormat;

    public MapperMySQLWin764() {
        this._model = MySQLModel.getInstane();
    }

    public MapperMySQLWin764(String path, String currentHashType, String currentHash, String databaseName) {
        this._path = path;
    ...
    public int createStructure(String path) {
        ...
        try {
            ...
            if (script != null) {
                ...
                parametersIn[2] = new Date(calendar.getTimeInMillis()); // _dateDumpFile,
                parametersIn[3] = "Windows 7 x64"; //_operatingSystemsDumpFile,
