 ...
 * @author Gonzalo
 */
public class EntityAddressFamilyWin32 extends EntityAddressFamily {
    ...
    public EntityAddressFamilyWin32() {
        try {

            this.setAttributes(new HashMap<String, EntityAttribute>());
            EntityAttribute a0 = new EntityAttribute("IPVersion", 0x00C, "", "int 8", false);
