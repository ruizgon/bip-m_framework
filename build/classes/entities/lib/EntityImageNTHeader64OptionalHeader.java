 ...
 * @author Gonzalo
 */
public class EntityImageNTHeader64OptionalHeader extends Entity{

    public EntityImageNTHeader64OptionalHeader() {
        try {
            ...
            /**
             * complexType: [] --> Array
             * Array [16] RVA: [0] --> ExportDirectory
             */
            EntityAttribute a0 = new EntityAttribute("DataDirectory", 0x070, "[]", "int 32", 16, false);
            this.getAttributes().put("DataDirectory", a0);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
