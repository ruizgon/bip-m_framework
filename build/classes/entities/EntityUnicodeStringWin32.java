 ...
 * @author alberdij
 */
public class EntityUnicodeStringWin32 extends EntityUnicodeString{
    
    public static final long _SIZE_STRUCTURE = 0x8; // 3 elementos, 0x8 bytes

    public EntityUnicodeStringWin32() {
            ...
            EntityAttribute a2 = new EntityAttribute("Buffer", 0x004, "", "pointer32",false);
    ...
    public void getAttributesContent(long position, Map.Entry<String, EntityAttribute> e) {
        if (this.getParser() != null) {
            ...
            EntityUnicodeStringWin32 unicodeString = (EntityUnicodeStringWin32) parser.getUnicodeStringContent(position,e);
