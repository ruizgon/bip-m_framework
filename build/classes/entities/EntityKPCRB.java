 ...
 * @author Gonzalo
 */
public class EntityKPCRB  extends Entity{

    private EntityThread _currentThread;

    public EntityThread getCurrentThread() {
        return _currentThread;
    }

    public void setCurrentThread(EntityThread _currentThread) {
        this._currentThread = _currentThread;
    }
