 ...
 * @author alberdij
 */
public class EntityPebLdrDataWindows732 extends EntityPebLdrData{
    
    //Esta entidad representa la estructura _PEB_LDR_DATA
    
    public static final long _SIZE_STRUCTURE = 0x30; // // 9 elements, 0x30 bytes (sizeof)
    
    public EntityPebLdrDataWindows732() {
        try {
            this.setTag(_TAG);

            this.setAttributes(new HashMap<String, EntityAttribute>());

            EntityAttribute a0 = new EntityAttribute("InLoadOrderModuleList", 0x00C, null, "EntityList", false, new EntityListWin32());
            this.getAttributes().put("InLoadOrderModuleList", a0);
            EntityAttribute a1 = new EntityAttribute("InMemoryOrderModuleList", 0x014, null, "EntityList", false, new EntityListWin32());
            this.getAttributes().put("InMemoryOrderModuleList", a1);
            EntityAttribute a2 = new EntityAttribute("InInitializationOrderModuleList", 0x01C, null, "EntityList", false, new EntityListWin32());
