 ...
 * @author Gonzalo
 */
public class SeekerHiveWin732 extends SeekerHive{
    ...
    @Override
    public EntityCell getFirstCell(EntityHHiveHBaseBlock hive) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public EntityCell getNextCell(EntityCell hive) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public EntityCell getPrevCell(EntityCell hive) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
