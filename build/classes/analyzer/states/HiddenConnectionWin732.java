 ...
 * @author Gonzalo
 */
public class HiddenConnectionWin732 extends ConnectionStateWin732 {

    public static final String _STATE_LABEL = "Hidden";

    public HiddenConnectionWin732() {
    ...
    public HiddenConnectionWin732(PersistenceObject persistenceObject) {
        this.setEntityTag(_TAG);
        String tag = _TAG + "_" + _STATE_LABEL;
        this.setTag(tag);
        this.setStateLabel(_STATE_LABEL);
