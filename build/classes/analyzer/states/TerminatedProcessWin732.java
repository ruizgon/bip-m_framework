 ...
 * @author Gonzalo
 */
public class TerminatedProcessWin732 extends ProcessStateWin732 {

    public static final String _STATE_LABEL = "Terminated";

    public TerminatedProcessWin732() {
        this.setTag(_TAG);
        this.setStateLabel(_STATE_LABEL);
    }

    public TerminatedProcessWin732(PersistenceObject persistenceObject) {
        this.setTag(_TAG);
        this.setStateLabel(_STATE_LABEL);
