 ...
 * @author juani
 */
public class MapperConnectionMySQLWin764 extends MapperConnection {

    public MapperConnectionMySQLWin764() {
    ...
    public int persist(Entity entity) {
        ...
        try {
            EntityWindows764TCPConnection tcpConnection = null;
            EntityWindows764UDPConnection udpConnection = null;

            EntityAddressFamilyWin64 addressFamily = null;
            EntityLocalAddressWin64 localAddress = null;
            EntityAddressInfoWin64 addressInfo = null;
            ...
            if (entity.getaS() != null) {
                if (null == this.getConnectionByVirtualAddress((String) entity.getaS().getVirtualAddressHex())) {
                    if (entity instanceof EntityWindows764TCPConnection) {

                        tcp = 1;
                        tcpConnection = (EntityWindows764TCPConnection) entity;
                        addressFamily = (EntityAddressFamilyWin64) tcpConnection.getAttributes().get("AddressFamily").getEntity();
                        addressInfo = (EntityAddressInfoWin64) tcpConnection.getAttributes().get("AddressInfo").getEntity();
                        process = (EntityWindows764Process) tcpConnection.getAttributes().get("Owner").getEntity();
                        connectionState = (EntityWindowsConnectionState) tcpConnection.getAttributes().get("State").getEntity();
                    } else if (entity instanceof EntityWindows764UDPConnection) {
                        tcp = 0;
                        udpConnection = (EntityWindows764UDPConnection) entity;
                        addressFamily = (EntityAddressFamilyWin64) udpConnection.getAttributes().get("AddressFamily").getEntity();
                        localAddress = (EntityLocalAddressWin64) udpConnection.getAttributes().get("LocalAddres").getEntity();
                        process = (EntityWindows764Process) udpConnection.getAttributes().get("Owner").getEntity();
                    }
                    ...
                    if (tcp != -1) {
                        ...
                        if (tcp == 1) {
                            ...
                            idConnection = (long) parametersOut[0];

                            EntityList list = (EntityListWin64) tcpConnection.getAttributes().get("ConnectionLinks").getEntity();
    ...
    public ArrayList<EntityConnection> getConnectionList(ConnectionState _connectionState, EntityConnection _entityConnection) {
        ...
        try {
            ...
            while (cachedRowSet.next()) {
                EntityConnection e = new EntityWindows764TCPConnection();
            ...
            //******************* VERIFICAR SI HAY QUE INSERTAR MÁS VALORES *************************
                ...
                EntityAddressInfo _ai = new EntityAddressInfoWin64();
                ...
                EntityList eList = new EntityListWin64();
            ...
            while (cachedRowSet.next()) {
                EntityConnection e = new EntityWindows764UDPConnection();
    ...
    public EntityConnection getConnectionByVirtualAddress(String virtualAddress) {
        ...
        try {
            ...
            while (cachedRowSet.next()) {
                e = new EntityWindows764TCPConnection();
...
//******************* VERIFICAR SI HAY QUE INSERTAR MÁS VALORES *************************
            ...
            if (e == null) {
                ...
                while (cachedRowSet.next()) {
                    e = new EntityWindows764UDPConnection();
