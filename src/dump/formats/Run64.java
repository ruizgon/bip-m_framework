 ...
 * @author Gonzalo
 */
public class Run64 extends Run {

    public static int _RUN_SIZE = 128;
    public static int _START_ADDRESS_SIZE = 64;
    public static int _LENGTH_SIZE = 64;

    public Run64(long _startOffset, boolean _littleEndian) {
    ...
    public void obtainRunData() {
        try {
            ...
            String hex = "0000000000000000" + String.format("%" + String.valueOf(_START_ADDRESS_SIZE / 16) + "X", Long.parseLong(content, 2));
            ...
            hex = "0000000000000000" + String.format("%" + String.valueOf(_START_ADDRESS_SIZE / 16) + "X", Long.parseLong(content, 2));
