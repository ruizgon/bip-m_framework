 ...
 * @author Gonzalo
 */
public class ActiveConnectionWin764 extends ConnectionStateWin764 {

    public static final String _STATE_LABEL = "Active";

    public ActiveConnectionWin764() {
    ...
    public ActiveConnectionWin764(PersistenceObject persistenceObject) {
        this.setEntityTag(_TAG);
        String tag = _TAG + "_" + _STATE_LABEL;
        this.setTag(tag);
        this.setStateLabel(_STATE_LABEL);
    ...
    public List<Entity> getList() {
        ...
        try {
            List<EntityConnection> connectionList = this.getPersistenceObject().getConnectionList(this, new EntityWindows764TCPConnection());
