...
import analyzer.states.TerminatedProcessWin764;
 ...
 * @author Gonzalo
 */
public class SeekerProcessWin764 extends SeekerProcess implements IAnalyzerThread{
    public SeekerProcessWin764(ProcessState state) {
    ...
    public SeekerState obtainPosibleSeekerState(String modifier) {
        ...
        try {
            ...
            switch (modifier) {
                case "active":
                    state = new ActiveProcessWin764(this.getAService());
                    break;
                case "hidden":
                    state = new HiddenProcessWin764(this.getAService());
                    break;
                case "terminated":
                    state = new TerminatedProcessWin764(this.getAService());
                    break;
                default:
                    state = new ActiveProcessWin764(this.getAService());
                    break;
