 ...
 * @author Gonzalo
 */
public class EntityAddressInfoWin64 extends EntityAddressInfo {

    public static final boolean _RESOLEV_MULTIPLICIY = true;
    
    public EntityAddressInfoWin64() {
        try {

            this.setAttributes(new HashMap<String, EntityAttribute>());
            EntityAttribute a0 = new EntityAttribute("Local", 0x000, "ip", "int 32", 1, false, 0, true);
            this.getAttributes().put("Local", a0);
            EntityAttribute a1 = new EntityAttribute("Remota", 0x010, "ip", "int 32", 1, false, 0, true);
