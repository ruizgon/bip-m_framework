 ...
 * @author Gonzalo
 */
public class EntityLocalAddressWin64 extends EntityLocalAddress{

    public EntityLocalAddressWin64() {
        try {

            this.setAttributes(new HashMap<String, EntityAttribute>());
            EntityAttribute a0 = new EntityAttribute("Local", 0x010, "ip", "int 32", 1, false, 2, true);
    ...
    public void getAttributesContent(long position, Map.Entry<String, EntityAttribute> e) {
        if (this.getParser() != null) {
            if (this.getParser() instanceof ParserWin64Connection) {
                ...
                if (this.getParser() instanceof ParserWin64Socket) {
