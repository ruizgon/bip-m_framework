 ...
 * @author Gonzalo
 */
public class EntityWin732KPROCESS extends EntityKPROCESS {

    public static final String _TAG = "KPROCESS";
    public static final long _SIZE_STRUCTURE = 0x98; // 34 elementos, 0x98 bytes 

    public EntityWin732KPROCESS() {
        ...
        try {
            ...
            EntityAttribute a0 = new EntityAttribute("DirectoryTableBase", 0x018, "", "int 32", false);
